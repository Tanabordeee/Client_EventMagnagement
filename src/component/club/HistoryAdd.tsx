                ...
                {histevent.map((value , index) => {
                    return(
                        <div className="2xl:w-1/3 w-1/2 max-lg:w-1/1 flex justify-center items-center pt-10">
                            <div className=" mx-3 my-2 rounded-xl flex flex-col justify-center items-center"><h1 className="text-2xl font-bold">Event {index + 1}</h1><EventClub Event = {value}/></div>
                        </div>
                    )
                })}
            </div>
