    ...
    return (
      <div>
          ...
          <div className="flex justify-center">
              <div className="flex w-full max-sm:grid p-5 max-sm:p-2 justify-center md:justify-between max-md:mx-2 mx-5">
                  ...
                  <div className="flex flex-col items-center justify-center">
                      <p className="p-1 px-5 text-lg flex justify-center">{Eventprop.eventName}</p>
                      <p className="p-1 px-5 text-lg flex justify-center">เงื่อนไข : {Eventprop.detail}</p>
                      <p className="p-1 px-5 text-lg flex justify-center">วันที่ :{dayjs(Eventprop.eventDate).format("YYYY-MM-DD")} </p>
                      <p className="p-1 px-5 text-lg flex justify-center">เวลา :{Eventprop.time}</p>
                      <p className="p-1 px-5 text-lg flex justify-center">contact</p>
                      <p className="p-1 px-5 text-lg flex justify-center">
