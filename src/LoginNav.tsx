        ...
        <div className="flex flex-1 justify-center rounded-xl bg-gray-200 p-10 m-5 shadow-xl max-sm:shadow-none">
            <div className= " flex items-center justify-center rounded-xl">
                <div className="flex flex-col justify-center border-gray-100 gap-5 p-20 px-10 md:px-40 rounded-xl shadow-xl items-center max">
                    ...
                    <button className="hover:cursor-pointer m-3 w-[100%] h-15 rounded-xl flex justify-center items-center shadow-xl bg-green-500 text-center text-lg text-white transition-transform transform hover:scale-110"
                        onClick={loginuser}>
                        User
                    </button>
                    <button className="hover:cursor-pointer m-3 w-[100%] h-15 rounded-xl flex justify-center items-center shadow-xl bg-green-500 text-center text-lg text-white transition-transform transform hover:scale-110"
